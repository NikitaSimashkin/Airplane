...
public class Sprite {
    ...
    protected static final int height = DrawThread.get_height(), width = DrawThread.get_width();
    ...
    public Rect create_rect_minus(int a, int b, int c, int d){ //создает измененный прямоугольник
